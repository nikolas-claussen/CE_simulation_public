...
n_x = 26 # for cable: 35, 30. for bridge: 26, 42
n_y = 42 

noise_gaussian = 0.075
isogonal = 0
orientation = "bridge" # "bridge" or "cable"
...
initial_strains = np.array([0.05, 0.1, 0.15, 0.2, 0.3]) #np.array([0.05, 0.1, 0.15, 0.2, 0.25, 0.3])  
etas = [0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9] #  [0.8, 0.85, 0.9,] #
reps = [1, 2, 3, 5, 6] #np.array([4, 5, 6]) # number of replicates # 1, 2, 3
