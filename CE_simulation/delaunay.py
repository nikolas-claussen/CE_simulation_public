...
## add methods to transform vertices, shear rotation
...
def get_double_angles(mesh):
    angles = mesh.get_angles()
    double_angles = {key: (val+angles[mesh.hes[key].twin._heid]
                       if mesh.hes[key].twin.face is not None else val)
