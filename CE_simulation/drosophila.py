...
# %% auto 0
__all__ = ['fridtjof_colors', 'fridtjof_colors_new', 'save_self', 'create_rect_initial', 'plot_mesh', 'get_normalized_bbox',
           'make_segments', 'colorline', 'get_p_over_sqrt_A']
...
# %% ../04_drosophila_simulation.ipynb 73
